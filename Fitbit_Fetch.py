...
if AUTO_DATE_RANGE:
    ...
    for date_str in date_list:
        get_intraday_data_limit_1d(date_str, [('heart','HeartRate_Intraday','1sec'),('steps','Steps_Intraday','1min'),('floors','Floors_Intraday','1min')]) # 3 queries x number of dates ( default 3)
